...
const Dashboard = () => {
  return (
    <>
      <div className="fixed top-0 left-0 z-50 h-full w-64 bg-white text-black transition-all duration-300 ease-in-out">
        <nav className="mt-6">
          <ul className="space-y-3">
            ...
            <li className="flex justify-center mb-8">
              <Link to="/" className="flex items-center space-x-3">
                {" "}
                {/* Thêm flex và space-x-3 để căn chỉnh */}
                <img src="/logo.png" alt="Logo" className="h-10 w-auto" />
                <span className="text-lg font-semibold">Nhóm 4</span>{" "}
                {/* Thêm font-semibold để chữ nổi bật */}
              </Link>
            </li>
            ...
            <li>
              ...
              >
                ...
                <span className="ml-4 font-sans text-lg">Create</span>
              </Link>
            </li>
            <li>
              <Link
